...
<head>
  ...
  <title>Minimarket Lluace | Escritorio</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper" style="background-color: #cc00cc">

    <header class="main-header" style="background-color: #cc00cc">
    <!-- Logo -->
    <a href="escritorio.php" class="logo" style="background-color: #ff9900; height: 60px">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>Llauce</b> </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Minimarket Llauce</b> </span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color: #ff9900">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Interación Hombre-Maquina Proyecto UTP
                  <small>2023</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer" style="background-color: #ff9966">
                <div class="pull-left">
